...
public class Recognizer2{
	...
	public static org.bytedeco.javacpp.opencv_core.Mat MatCVtoMatJavaCpp(org.opencv.core.Mat frame){
		return Recognizer2.bufferedImageToMat(Utils.matToBufferedImage(frame));
	}
	
	
	
    public void Prediction(org.opencv.core.Mat frame) {
        String trainingDir = "Face_Recog/A";
        Mat testImage = opencv_imgcodecs.imread("Face_Recog/face27.bmp", opencv_imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        ...
        for (File image : imageFiles) {
            Mat img = opencv_imgcodecs.imread(image.getAbsolutePath(), opencv_imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        ...
        FaceRecognizer faceRecognizer = createEigenFaceRecognizer(80, 2000);
